...
import br.com.namaste.pontointeligente.api.dtos.LancamentoDto;
import br.com.namaste.pontointeligente.api.enums.TipoEnum;
...
public class LancamentoController {
	...
	/**
	 * Valido um funcionario, verificando se ele é existente e válido no sistema
	 * 
	 * @param lancamentoDto
	 * @param result 
	 */
	...
	private void validarFuncionario(LancamentoDto lancamentoDto, BindingResult result) {
		...
		if (!funcionario.isPresent()) {
			result.addError(new ObjectError("funcionario", "Funcionário não encontrado. E-mail inexistente"));
		}
	}
	...
	public ResponseEntity<Response<String>> remover (@PathVariable ("id") Long id) {
		...
		if (!lancamento.isPresent()) {
			log.info("Erro ao remover devido ao lançamento ID: {} ser válido", id);
